...
App.prototype.animarTijolos = function() {
    ...
    function adicionarFiada() {
        ...
        row.style.cssText = 'display:flex;gap:2px;transition:all 0.3s;';
...
App.prototype.previewFotoObra = function(e) {
    ...
    var r=new FileReader();r.onload=function(ev){document.getElementById('vagaFotoPreview').src=ev.target.result;};r.readAsDataURL(f);
    var s=this;var r2=new FileReader();r2.onload=function(ev){s.vagaFotoBase64=ev.target.result;};r2.readAsDataURL(f);
};
